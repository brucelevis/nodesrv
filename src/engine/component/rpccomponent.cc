...
RPCMethod& RPCMethod::operator <<(::google::protobuf::Message* message)
{
...
int RPCComponent::recv(Message* msg)
{
...
int RPCComponent::post(lua_State* L)
{
